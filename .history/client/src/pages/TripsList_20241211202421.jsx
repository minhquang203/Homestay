  ...
  const handleBooking = async (trip) => {
    try {
      const paymentData = {
        ...
        redirectUrl: "http://localhost:3000/payment-success", // Đường dẫn khi thanh toán thành công
        ipnUrl: "http://localhost:3000/payment-cancel", // Đường dẫn khi thanh toán thất bại
      };
