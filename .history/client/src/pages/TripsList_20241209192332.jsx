...
const TripsList = () => {
  ...
  onst handleBooking = async (trip) => {
    // Tạo đơn thanh toán thông qua API MoMo
    try {
        const paymentData = {
            amount: trip.totalPrice, // Số tiền thanh toán
            orderId: `order-${trip.listingId._id}`, // Mã đơn hàng duy nhất
            orderInfo: "Thanh toán chuyến đi", // Thông tin đơn hàng
            redirectUrl: "http://localhost:3000/payment-success", // URL quay lại sau khi thanh toán thành công
            ipnUrl: "http://localhost:3000/payment-cancel", // URL quay lại nếu thanh toán bị hủy
        };
