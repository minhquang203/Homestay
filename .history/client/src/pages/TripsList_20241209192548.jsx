...
const TripsList = () => {
  ...
  const [error, setError] = useState(null); // Thêm state error để quản lý lỗi
  ...
  const handleBooking = async (trip) => {
    try {
      ...
      if (result && result.paymentUrl) {
        window.location.href = result.paymentUrl; // Điều hướng đến trang thanh toán MoMo
      } else {
