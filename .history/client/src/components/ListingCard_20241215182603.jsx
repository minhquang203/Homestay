...
const ListingCard = ({
  ...
  const handleBooking = async () => {
    ...
    const bookingData = {
      ...
      bookingId: listingId,  // Mã booking (hoặc có thể là listingId từ props)
    };
  ...
  // Sửa lỗi handleCardClick nếu không có hàm này
  const handleCardClick = () => {
    // Bạn có thể để trống hoặc xử lý theo cách bạn muốn, ví dụ:
