      ...
      try {
        ...
        const response = await fetch('http://localhost:3002/payment/create_payment_url', {
          ...
          body: JSON.stringify({
            ...
            listingId: listingId, // Gửi listingId
            userId: userId, // Gửi userId (lấy từ Redux hoặc props)
            startDate: startDate, // Gửi startDate
            endDate: endDate, // Gửi endDate
            hostId: creator, // Gửi hostId (creator từ props)
          }),
        });
