...
router.post('/create_payment_url', async (req, res) => {
  try {
    ...
    const ordertotalPrice = parseInt(totalPrice) * 100; // Nhân với 100 để tính bằng đồng VND
