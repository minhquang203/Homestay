...
router.get("/me", async (req, res) => {
  ...
  try {
    ...
    const decoded = jwt.verify(token, process.env.JWT_SECRET); // Sử dụng bí mật JWT từ file .env
    const user = await User.findById(decoded.id); // Lấy thông tin người dùng từ DB
